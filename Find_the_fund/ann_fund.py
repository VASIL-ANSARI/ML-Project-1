...
#score : 0.99820  (evaluated using  sklearn.metrics.accuracy_score())
...
model_classifier=classifier.fit(x_train,y_train, batch_size = 10, nb_epoch = 100)
...
res.to_csv('submission-ann.csv', header=True, index=False) 
